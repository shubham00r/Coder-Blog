...
//   return (
//     <div className="flex items-center justify-between my-8 border-b-2 border-gray-">
//       <ul className="flex items-center ">
//         <li className="pb-5 mr-6 border-b-4 rounded-sm">
//           <Link href="#"> Resent </Link>
//         </li>
//         {categories.map((categories) => {
//           return (
//             <li key={categories.id} className="pb-5 mr-6 border-b-4 rounded-sm">
//               <Link href="#">{categories.attributes.Title}</Link>
//             </li>
//           );
//         })}
//       </ul>
